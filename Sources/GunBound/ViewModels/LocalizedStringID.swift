...
public struct LocalizedStringID: RawRepresentable, Equatable, Hashable, Sendable {
    ...
    public static var serverAccessError: LocalizedStringID { LocalizedStringID(rawValue: 200) }
    /// id 201 / code 2 — a network problem, or the wait ran too long.
    public static var accessTimeExpired: LocalizedStringID { LocalizedStringID(rawValue: 201) }
    /// id 205 / code 6 — wrong password.
    public static var loginError: LocalizedStringID { LocalizedStringID(rawValue: 205) }
    /// id 208 / code 9 — the client's internal data was altered.
    public static var internalDataError: LocalizedStringID { LocalizedStringID(rawValue: 208) }
    /// id 209 / code 10 — the channel is full.
    public static var channelAccessError: LocalizedStringID { LocalizedStringID(rawValue: 209) }
    /// id 212 / code 13 — the game room is full.
    public static var gameRoomAccessError: LocalizedStringID { LocalizedStringID(rawValue: 212) }
    /// id 213 / code 14 — the game room couldn't be created.
    public static var gameRoomCreationError: LocalizedStringID { LocalizedStringID(rawValue: 213) }
    /// id 215 / code 16 — the room is in a match; can't enter.
    public static var gameRoomBlocked: LocalizedStringID { LocalizedStringID(rawValue: 215) }
    /// id 216 / code 17 — not ready to start the match yet.
    public static var gameStartError: LocalizedStringID { LocalizedStringID(rawValue: 216) }
    /// id 220 / code 21 — client/server version mismatch.
    public static var versionError: LocalizedStringID { LocalizedStringID(rawValue: 220) }
    /// id 226 / code 27 — not enough gold or cash for the purchase.
    public static var buyError: LocalizedStringID { LocalizedStringID(rawValue: 226) }
}
