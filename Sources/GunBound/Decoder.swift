...
public struct GunBoundDecoder: @unchecked Sendable {
    ...
    private func assertNotEnd() throws {
        ...
        guard isAtEnd == false else {
            ...
            throw DecodingError.valueNotFound(
                Any?.self, DecodingError.Context(codingPath: self.decoder.codingPath + [Index(intValue: self.currentIndex)], debugDescription: "Unkeyed container is at end."))
        }
    }
}
