/// Room Player Flag Update Notification
///
...
public struct RoomPlayerFlagUpdateNotification: GunBoundPacket, GunBoundPacketEncodable, GunBoundPacketDecodable, Equatable, Hashable, Sendable {

    public static var opcode: Opcode { .roomPlayerFlagUpdateNotification }
