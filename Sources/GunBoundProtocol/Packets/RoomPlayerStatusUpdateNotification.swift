/// Room Player Status Update Notification
///
/// Single-byte per-slot field update — one of six fields also bulk-populated
/// by `RoomDetailResponse` (`0x2105`).
///
/// **Note:** Reconstructed from static analysis of the original client, not a live packet capture or verified traffic.
public struct RoomPlayerStatusUpdateNotification: GunBoundPacket, GunBoundPacketEncodable, GunBoundPacketDecodable, Equatable, Hashable, Sendable {

    public static var opcode: Opcode { .roomPlayerStatusUpdateNotification }
